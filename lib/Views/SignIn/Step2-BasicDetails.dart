                  ...
                  onPressed: () async {
                    if (_fbKey.currentState.saveAndValidate()) {
                      final insert = BasicDetialModel(
                        ...
                        candidateExperienceId: experienceRadioId,
                      ...
                      log.i("Current City ID " +
                          insert.candidateCurrentCityId.toString());
                      log.i("JobRole " +
                          insert.candidatePreferredJobRoleList.toString());
                      log.i("Total Experience " +
                          insert.candidateTotalworkexp.toString());
                      // log.i("Experience " + insert.candidateExperienceId);
                      log.i("=======================================");
                      ...
                      !result.error ? ScaffoldMessenger.of(context)
                              .showSnackBar(
                                SnackBar(
