...
class CareerPreference extends StatefulWidget {
  CareerPreference({Key key, this.uuid, this.experienceId}) : super(key: key);
  String uuid;
                                        ...
                                        .showSnackBar(
                                          SnackBar(
                                            content: Row(children: const [
                                              ...
                                              SizedBox(width: 7),
                                              Text(
                                                  "Career Preferences Added Successfully ..."),
                                            ]),
  ...
  Widget Location(BuildContext context) {
    return Column(children: [
      DropdownSearch<Cities>.multiSelection(
        ...
        //  return  apiServices.getCity(query: filter)
        // },
        ...
        onFind: (val) async {
          ...
          fetchCity(query: query);
          return _apiResponseLocation.data;
        },
        // ignore: deprecated_member_use
        hint: "Select Preferred Location",
        showSearchBox: true,
