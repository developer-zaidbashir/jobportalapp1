  ...
  getLanguages() {
    if (isEditing) {
      ...
      apiServices.populateLanguageUpdate(widget.uuid).then((response) {
        ...
        myController.text = languagePopulate.Languagename == "" ? languagePopulate.Language : languagePopulate.Languagename;
        myController2.text = languagePopulate.ProficiencyName;
        profId = languagePopulate.ProficiencyId;
        read = languagePopulate.Read == "1" ? true : false;
        write = languagePopulate.Write == "1" ? true : false;
        speak = languagePopulate.Speak == "1" ? true : false;
