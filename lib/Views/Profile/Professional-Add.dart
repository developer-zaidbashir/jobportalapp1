  ...
  getprof() {
    if (isEditing) {
      ...
      apiServices.populateProfProfessionalUpdate(widget.uuid).then((response) {
        ...
        groupValue =
            int.parse(professionalPopulate.candidateexpIscurrentcompany);
        currentOrganisationNameCntrl.text =
            professionalPopulate.candidateexpIscurrentcompany == "1"
                ? professionalPopulate.OrganizationName
                : "";
        currentDesignationCntrl.text =
            professionalPopulate.candidateexpIscurrentcompany == "1"
                ? professionalPopulate.Designation
                : "";
        salaryCountProfile.text =
            professionalPopulate.candidateexpIscurrentcompany == "1"
                ? professionalPopulate.Salary
                : "";

        //prevoius
        previousOrganisationNameCntrl.text =
            professionalPopulate.candidateexpIscurrentcompany == "0"
                ? professionalPopulate.OrganizationName
                : "";
                            ...
                            children: [
                              ...
                              Padding(
                                      ...
                                      child: TypeAheadFormField(
                                        validator: (value) {
                                          if (value.isEmpty) {
                                            return "Select Current Organization Name";
                                          }
                                        },
                              ...
                              groupValue == 1
                                  ? TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: " Enter Current Annual Salary ",
                                        hintStyle: TextStyle(
                                          color: Colors.blueGrey,
                                          fontFamily: "ProximaNova",
                                          fontWeight: FontWeight.w500,
                              ...
                              groupValue == 0
                                  ? Padding(
                                      ...
                                      child: TypeAheadFormField(
                                        validator: (value) {
                                          if (value.isEmpty) {
                                            return "Select Previous Organization Name";
                                          }
                                        },
                                        textFieldConfiguration:
                                            TextFieldConfiguration(
                                                ...
                                                decoration: InputDecoration(
                                                    hintText: ' Select Previous Organization Name')),
                                        debounceDuration:
                                            Duration(milliseconds: 500),
                                        suggestionsCallback:
                                            ApiServices.getCompany,
                              ...
                              groupValue == 0
                                  ? TextFormField(
                                      validator: (value) {
                                        if (value.isEmpty) {
                                          return "Enter Previous Designation";
                                        }
                                        return null;
                                      },
                                      inputFormatters: <TextInputFormatter>[
                                      ...
                                      decoration: InputDecoration(
                                        hintText: "Enter Previous Designation",
                                        hintStyle: TextStyle(
                                          color: Colors.blueGrey,
                                          fontFamily: "ProximaNova",
                                          fontWeight: FontWeight.w500,
                              ...
                              groupValue == 0
                                  ? TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: "Enter Previous Annual Salary",
                                        hintStyle: TextStyle(
                                          color: Colors.blueGrey,
                                          fontFamily: "ProximaNova",
                                          fontWeight: FontWeight.w500,
                                  ...
                                  final insert = groupValue == 1
                                      ? PostProfession(
                                          ...
                                          candidateexpDesignation:
                                              currentDesignationCntrl.text,
                                          candidateexpStartdate: selectedDateWorkingSince
                                              .toString()
                                              .split(" ")[0],
                                          candidateexpSalary:
                                              salaryCountProfile.text,
