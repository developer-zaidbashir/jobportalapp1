...
class _UpdateCareerPreferenceState extends State<UpdateCareerPreference> {
  ...
  CareerPreferencePopulate preference;
  String errorMessage;
  ...
  getPref() {
      ...
      apiServices.getCareerPreferencePopulate().then((response) {
        setState(() {
          isLoading = false;
        });
        if (response.error) {
        ...
        lakh.text = preference.candidateExpectedctc;
                                        ...
                                        Flexible(
                                          child: Padding(
                                            ...
                                            child: DropdownButtonFormField(
                                              ...
                                              hint: Text("Select Preferred Shift"),
                                              value: myShift,
                                              onChanged: (newValue) {
                                                setState(() {
                                                  myShift = newValue;
