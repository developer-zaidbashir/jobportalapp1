...
class AppliedJobsUi extends StatefulWidget {
  const AppliedJobsUi({Key key}) : super(key: key);

  @override
  State<AppliedJobsUi> createState() => _AppliedJobsUiState();
}

class _AppliedJobsUiState extends State<AppliedJobsUi> {
  ...
  getData() async {
    ...
    apiResponse = await apiService.appliedJobs(insert);
