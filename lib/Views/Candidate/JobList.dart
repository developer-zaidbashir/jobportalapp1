...
class JobListUi extends StatefulWidget {
  const JobListUi({Key key}) : super(key: key);

  @override
  State<JobListUi> createState() => _JobListUiState();
}

class _JobListUiState extends State<JobListUi> {
  ...
  getData() async {
    ...
    apiResponse = await apiService.jobList(insert);
