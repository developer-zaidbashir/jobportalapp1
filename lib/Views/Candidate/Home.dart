...
class _HomePageState extends State<HomePage> {
            ...
            child: Column(
              ...
              children: [
                ...
                GFButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => const BlueCollar()));
                  },
  ...
  Widget _header(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
         nameLoading?const CircularProgressIndicator(): Text(name,
              ...
              children: [
                for (var i = 0; i < obj.length; i++)
                  _recommendedJob(context,
                    company: obj[i]["companyName"] ,
                    img: Images.google,
                    title: obj[i]["jobHeadline"],
                    sub: obj[i]["jobMaxSalary"],
                    // isActive: obj[0]["jobHeadline"]?true: false
                  ),
                // _recommendedJob(context,
                //     company: "DropBox",
                //     img: Images.dropbox,
  ...
  getName()async{
    ...
    name = await secureStorage.read(key: "candidateName");
    setState(() {
      nameLoading = false;
    });
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _carosel(context),
     isLoadingBasicProfile? Center(child: CircularProgressIndicator(),):PieChartSample2(),
                _warning(context),
                _strenght(context),
